...
# Function to calculate the average values, extending the period if necessary
...
# Function to handle the last mix
...
def process_file(file_path):
    ...
    for hole in unique_holes:
        ...
        for i, mix in enumerate(mix_types):
            ...
            # Handle averages differently for the last mix
            if i == len(mix_types) - 1:
    ...
    # Ensure the output file is not open or locked by another process
    try:
    ...
    # Create and save the mix count summary
...
server = app.server  # This line is necessary for deployment

# Layout of the Dash app
app.layout = html.Div([
    html.H1('Grout Injection Analysis'),
    dcc.Upload(
        id='upload-data',
        children=html.Div([
            'Drag and Drop or ',
...
def parse_contents(contents, filename):
    ...
    return html.Div([
        html.H5(filename),
        html.H6(datetime.datetime.fromtimestamp(date_modified)),
